        ...
        <div class="container-fluid bar">
            ...
            <div class="collapse navbar-collapse nav" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/Acheter.html">Acheter</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="cars d-block d-md-flex justify-content-between conts">
            <div class="card mx-auto " style="width: 18rem;">
                <img class="card-img-top"
                    src="https://voplus-kifal.imgix.net/kavo/voplus_kifal/presentationduvehicule1_expertise_1625490532820_556390.jpg"
                    alt="Card image cap">
                <div class="card-body">
